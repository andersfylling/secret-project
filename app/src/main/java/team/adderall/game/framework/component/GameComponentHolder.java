...
public class GameComponentHolder
{
    ...
    private final GameComponentInvoker initializer;
     ...
     * @param initializer
     */
    public GameComponentHolder(@NonNull final String name,
                               @NonNull final Object function,
                               @NonNull final List<String> parameters,
                               @NonNull final GameComponentInvoker initializer,
     ...
     */
    public void createDependencyTree(@NonNull final List<GameComponentHolder> components)
    {
     ...
     * @param p ignored
     * @return
     * @see GameComponentInvoker
     */
    public static Object defaultConstructorInvoker(@NonNull final Object constructor,
                                                   @NonNull final Object[] dependencies,
                                                   @Nullable Object p)
            throws
     ...
     * @see GameComponentInvoker
     */
    public static Object defaultMethodInvoker(@NonNull final Object method,
                                              @NonNull final Object[] dependencies,
